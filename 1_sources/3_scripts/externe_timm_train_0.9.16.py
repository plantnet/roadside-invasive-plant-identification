...
# -*- coding: utf-8 -*-
#
# Copy of the 'train.py' file from timm (https://github.com/huggingface/pytorch-image-models) version 0.9.16
# i.e. https://github.com/huggingface/pytorch-image-models/blob/v0.9.16/train.py
